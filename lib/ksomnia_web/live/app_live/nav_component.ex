    ...
    <div>
              ...
              <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <%= live_redirect [to: Routes.app_show_path(@socket, :show, @app), class: "ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"] do %>
                      <%= @app.name %>
                    <% end %>
                  </div>
                </li>
      ...
      <nav class="px-7 py-4 isolate flex divide-x divide-gray-200 rounded-lg">
        <%= live_redirect [
          ...
          class: "text-slate-500 hover:text-slate-700 group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-sm font-medium text-center hover:bg-gray-50 focus:z-10"
        ] do %>
